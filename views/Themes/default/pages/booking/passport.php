	...
	<div class="container clearfix">
		<div class="primary-content post">
			<div class="card">
				...
				<div class="clearfix">
                <div class="clearfix" style="margin-right:70px;"><?= $this->item['booking_passport']==0 ? ' <a href="/probookingcenter/booking/passport_insert/'.$this->item['book_id'].'?>" data-plugins="dialog" class="btn btn-blue rfloat"> <i class="icon-plus"></i> เพิ่ม</a> ': ''?></div>
                   ...
                   <?php foreach($this->item['passport'] as $key => $value){ ?>
                        <tr>
                            ...
                            <td class="tac"><a target="_blank" class="fcb" href="/probookingcenter.admin/admin/upload/passport/<?=$value['pass_file_url']?>"><i class="icon-file-pdf-o"></i> กดเพื่อดูไฟล์</td>
                    ...
                    <?=$this->item['booking_passport'] ==0 ? '<a style="margin:1rem; margin-right:65px;" href="/probookingcenter/booking/passport_update/'.$this->item['book_id'].'?>" data-plugins="dialog" class="btn btn-blue rfloat"> <i class="icon-send-o"></i> บันทึก</a>' :'' ?>
                </div>
            </div>
         </div>
     </div>
