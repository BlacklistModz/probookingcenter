...
class Controller {
    ...
    public function handleLogin(){
        ...
        elseif( Cookie::get( COOKIE_KEY_ADMIN ) ) {
        ...
        if( !empty($_POST) && empty($error) ){
            ...
            try {
                ...
                if( $this->pathName == "admin" ){
                    ...
                    $id = $this->model->query('agency')->login($post['email'], $post['pass']);
                }
                ...
                if( !empty($id) ){
                    ...
                    if(!$this->model->query('agency')->is_username($post['email']) && !$this->model->query('user')->is_user($post['email']) ){
